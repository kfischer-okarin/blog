...
* It starts with an @
  ...
  people just come together to silently[fn::/mokumoku/ meaning silent] to work on their own projects. Basically being
  ...
  [[video:cyberpunk-rl-0001-at-sign-moving.mp4][An at sign moving over the screen]]
  ...
  #+begin_src ruby
    def tick(args)
      ...
      args.outputs.sprites << {
        ...
        path: 'sprites/zilk-16x16.png', source_x: 0 * 16, source_y: 11 * 16, source_w: 16, source_h: 16
      }
    end
  #+end_src
